...
class _UdpCommunicationPageState extends ConsumerState<UdpCommunicationPage> {
  ...
  final TextEditingController _sendPortController = TextEditingController();
  final TextEditingController _sendMessageController = TextEditingController();
  final ScrollController _scrollController = ScrollController();
  final FocusNode _receivePortFocus = FocusNode();
  final FocusNode _sendPortFocus = FocusNode();

  @override
  void initState() {
    super.initState();
    final udpState = ref.read(udpViewModelProvider);
    _receivePortController.text = udpState.receivePort;
    _sendAddressController.text = udpState.sendAddress;
    _sendPortController.text = udpState.sendPort;
    _sendMessageController.text = udpState.sendMessage;
  }
  ...
  void dispose() {
    ...
    _receivePortFocus.dispose();
    _sendPortFocus.dispose();
    super.dispose();
  }
